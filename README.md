...
| Recommendation Testing | Lapsed customers return on their own at a high rate — the real gap is acquisition, not retention; 2 of 6 candidate ideas didn't survive testing and were dropped | [docs/05-recommendations.md](docs/05-recommendations.md) | [notebooks/05_recommendation_testing.ipynb](notebooks/05_recommendation_testing.ipynb) |
| Customer Acquisition | A delivery platform's masked numbers show up 9x more often on a customer's first order than on repeat orders — a discovery channel, not a loyalty one, and its share of new customers is growing | [docs/06-customer-acquisition.md](docs/06-customer-acquisition.md) | [notebooks/06_customer_acquisition.ipynb](notebooks/06_customer_acquisition.ipynb) |
